    ...
    def step(self):
        ...
        for param in self.params:
            if param.grad is None:
                continue
            grad_data = ndl.Tensor(param.grad.data + self.weight_decay * param.data, dtype="float32")
...
class Adam(Optimizer):
    ...
    def step(self):
        ...
        for param in self.params:
            ...
            param.data = param.data - self.lr * (self.m[param]/(1 - self.beta1**self.t)) / ((self.v[param]/(1 - self.beta2**self.t))**0.5 + self.eps)
        ### END YOUR SOLUTION
